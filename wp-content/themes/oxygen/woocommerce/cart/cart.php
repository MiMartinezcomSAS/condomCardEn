		...
		<div class="col-md-4">
			...
			<?php if ( WC()->cart->coupons_enabled() ) { ?>
				<div class="coupon">
					...
					<label for="coupon_code up"><?php _e( 'You have a coupon?', 'woocommerce' ); ?>:</label> 
					...
					<form method="post" id="coupon-code-form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								<button type="submit" name="apply_coupon" class="btn btn-black"><?php _e('Update', 'woocommerce'); ?></button>
							</span>
						</div>
